...
## Introduction
This project implements an Image Classification pipeline using **ResNet50** to solve the Homework 1 competition. To improve robustness and accuracy, we utilize a **Model Ensemble** approach combining three different training runs:
