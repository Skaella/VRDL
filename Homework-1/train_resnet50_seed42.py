...
def main():
    # DIRECTORY SETUP
    FOLDER_NAME = "seed42_results"
    OUTPUT_DIR = os.path.join("outputs", FOLDER_NAME)
    os.makedirs(OUTPUT_DIR, exist_ok=True)

    LOG_PATH = os.path.join(OUTPUT_DIR, "logs_seed42.csv")
    MODEL_PATH = os.path.join(OUTPUT_DIR, "resnet50_seed42_best.pth")
    ...
    plot_loss_curve(tracker, suffix="seed42", output_dir=OUTPUT_DIR)
    plot_accuracy_curve(tracker, suffix="seed42", output_dir=OUTPUT_DIR)
    plot_confusion_matrix(
        model, val_loader, device, suffix="seed42", output_dir=OUTPUT_DIR
    )
