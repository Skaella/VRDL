...
def run_inference():
    ...
    DEFAULT_WEIGHTS = os.path.join(SCRIPT_DIR, "checkpoints", "promptir_best.pth")
    ...
    _, _, test_loader = get_dataloaders(os.path.join(SCRIPT_DIR, "dataset"), batch_size=1)
    ...
    with torch.no_grad():
        for batch in tqdm(test_loader):
            ...
            # The key must be the original filename (e.g., '0.png')
