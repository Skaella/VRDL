...
def main():
    ...
    DEFAULT_WEIGHTS = os.path.join(SCRIPT_DIR, 'runs', 'yolo_medical_run', 'weights', 'best.pt')
    DEFAULT_TEST_DIR = os.path.join(SCRIPT_DIR, 'hw3-data-release', 'test_release')
    DEFAULT_MAPPING = os.path.join(SCRIPT_DIR, 'hw3-data-release', 'test_image_name_to_ids.json')
